...
export const metadata: Metadata = {
  title: "About",
  description: "Learn more about Utkarsh Ranjan",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-12">
      <header className="mb-12">
        <h1 className="font-serif text-3xl font-bold mb-4">About Me</h1>
      </header>
      ...
      <div className="flex flex-col md:flex-row gap-8 mb-12">
        ...
        <div className="space-y-4">
          <p className="text-lg leading-relaxed">
            Hi, I&apos;m <strong>Utkarsh Ranjan</strong>. Welcome to my personal
            corner of the internet where I share my thoughts, learnings, and
            experiences.
          </p>
          ...
          <p className="text-muted leading-relaxed">
            ...
            you can find me reading, exploring new ideas, or enjoying a good
            cup of coffee.
          </p>
        </div>
      </div>
      ...
      <section className="mb-12">
        ...
        <p className="text-muted leading-relaxed mb-4">
          I&apos;m always happy to connect with like-minded people. Feel free to
